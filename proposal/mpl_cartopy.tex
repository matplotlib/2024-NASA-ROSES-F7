...
The objective of Matplotlib and Cartopy is provide and continuously improve
visualization tools for NASA researchers and engineers to enable them to complete
their missions.  To achieve this objective we will work directly with NASA
...
associated with NASA missions, Center, or data repository.  During these
consolations we will both gather information about the challenges facing NASA
researchers and engineers and provide guidance on how to use the libraries,
including whose development is being supported by NASA and those completed under
this grant.  This will ensure that Matplotlib's and Cartopy's development is
responsive to NASA needs and in same case a few hours working with an expert
can save days of effort.  In both cases NASA mission is made more efficient.

Matplotlib is currently being supported in part by 20-OSTFL20-0058 (20 ROSES
E.7) to refactor how data and data transformations pipelines are handled
...
In particular we work to refactor Cartopy to use these new tools which will in
turn improve both improve the performance, fix a long standing limitation, and
enable new features.
...
volunteer effort and NASA's support was critical the work being completed.
...
and thankless, which but all essential for the continued overall health of the
...
% to delete it.
% GML: I agree we should delete this paragraph, I'm not sure this is a risk that
% a review panel will care about, I think they will worry more about technical risks.
