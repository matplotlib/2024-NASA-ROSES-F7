...
conversations with personnel from NASA-ISRO SAR (NISAR) and Geospace Dynamics Constellation
(GDC); we are confident this approach will continue to be useful.
...
%%EF: I commented this out because I think it is saying almost exactly what the
%paragraph above has already said.  Either one could be kept, but we don't need both.
...
style changes to its \texttt{Artist}.  {\bf What is the next sentence supposed to mean?} The second change will
