...
code base over the full history of the project and over
6,800 % TODO
people have commented on GitHub , with many more
individuals having contributed in ways not easily tracked, such as asking and
answering questions on the mailing list and forums or doing peer-support and
advocacy in their home institutions.
...
packages from PyPI~\cite{pypi_stats} with over 10 million downloads
per week and is packaged by every major
...
Matplotlib.  Several highlights Matplotlib is used
\begin{itemize}[noitemsep]
\item to study galaxy evolution \cite{2022ApJ...940L..14N}
\item to study exoplanets \cite{2020AJ....160..116G, Barclay_2018,2019AJ....158...27L}
...
\item and to study the earth [NEED CITE]
\end{itemize}
