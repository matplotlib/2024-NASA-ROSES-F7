...
% the backlog, we were able to fix several long-standing bugs.
...
The Cartopy refactor will be a multi-step process of updating the Cartopy
codebase to take advantage of the new Matplotlib data model.  Specifically, the
Cartopy transform stack must be modified to use the new Matplotlib transforms
...
improvements and new features provided by the new data model. We will also work
on improving the performance of the geographic transforms within Cartopy by
reducing the number of calls to the underlying projection library and by
optimizing the transform stack to cache intermediate results where
possible. Each of these items can be broken up into smaller PRs that can be
reviewed and merged incrementally, so progress does not become blocked on a
single large PR. A specific feature to be enhanced is path transformations.

\paragraph{Path Transformations}

An area of focus for the Cartopy refactor is in the handling of path transformations from
...
missions.  This will be implemented as resources allow.
...
work.  We are optimistic that we will be able to recruit a qualified individual
without undue delay.  Additionally, by delaying the start of the second RSE
until Y2 of the grant we will be able to reduce the risk of delays in both the
search process and availability of the identified candidate.  We have now hired
two individuals as fulltime RSEs through NumFOCUS within reasonable time frames
and have almost 5 years of experience managing and paying RSEs through
NumFOCUS.
...
disruption, and have well established process in Matplotlib for communicating
...
For Cartopy, the proposed split in effort will be roughly
30\%\ for maintenance, 60\%\ for new
developent, and 10\%\ for
community
...
regular releases.  We will continue to maintain a semiannual release
...
available. Cartopy plans to follow the same release cycle as Matplotlib, but
...
run two efforts: an ``incubator'' channel on gitter and monthly New
...
Experience Engineer to fill the role of Contributor Experience Lead (CEL) for
Matplotlib at 192hrs / year for the duration of the grant and help with all
tasks.

Matplotlib strives to be an inclusive and open project; anyone who is willing
and able to contribute to the project should feel welcome to do so.  Building on
...
to continue outreach and support that encourages people to make their first PR to
the library, and, equally important, that turns one-time contributors into
long-term contributors.  As part of this we will better define existing roles
within the maintainer community
and create new ones as needed.

We will continue several activities to bring new contributors to the project.
First, we will continue to host monthly New Contributor Meetings --- started
...
Second, we will continue to track
...
practice of labeling issues as ``good first issues'' and providing detailed
...
pointers to the correct section of the code and a checklist of steps needed to get a
...
attendees to the Matplotlib contribution process.  We expect to run 2--3
sprints per year --- at events like Grace Hopper Celebration, Scipy, or PyData
...
understand our community.  Identifying and documenting the roles within the
...
project lead.  By providing a clear path to engagement we will encourage
people to participate.  Dr.\ Caswell will lead this effort starting in Y1Q2
and completing the initial documentation by Y1Q4.  The roles will be
re-evaluated Y4Q1.

We have previously tried to start a ``Triage Team'' in the organization with
the power to tag, milestone, and close issues.  However, these efforts have
never got off the ground (past writing documentation defining the role) because
we did not identify an initial ``Team Captain''.  To this end one of the tasks
of the CEL will be to serve as the inaugural Team Captain for at least
18 months starting Y1Q1.  They will be responsible for recruiting additional
team members and to identify and train a successor so the team will persist
past the end of the grant.  In addition to the direct benefit of improving
the issue triage and freeing the core-developers to spend more time reviewing
PRs, the Triage Team will bring more people into the developer community.


%The issue tracker is important
...
%on, and discussing priorities.


% and may provide a pathway to becoming regular contributors and maintainers.
...
We will continue to work with NumFOCUS to develop metrics that will help us
evaluate the efficacy of these efforts at expanding our community.  We have
...
%  - Set up and maintain (for the grant period, whatever that is) a triage team
%  for matplotlib
%  - Complete the CSCCE training with the steering council (this means attending
%  the sessions) and implementing appropriate parts of it to the matplotlib
%  community
%  - Improvements to the maintainer onboarding pipeline and a project lead
%  succession plan.
...
\begin{tabular}{|l|l|c|c|c|c|c|c|}
  ...
  Dr.\ Thomas A.\ Caswell & PI \& RSE   & 0.18 & 0.16 & 0.16 & 0.16 & 0.16 & 0.81 \\  \hline
  Dr.\ Greg Lucas         & CO-I \& RSE & 0.10 & 0.11 & 0.11 & 0.11 & 0.11 & 0.54 \\  \hline
  Dr.\ Kyle Sunden        & CO-I \& RSE & 0.00 & 1.00 & 1.00 & 1.00 & 1.00 & 4.00 \\  \hline
  ---                     & RSE         & 0.00 & 1.00 & 1.00 & 1.00 & 0.00 & 3.00 \\  \hline
  Quansight consultant    & CEE         & 0.10 & 0.10 & 0.10 & 0.10 & 0.00 & 0.40 \\  \hline
  \multicolumn{2}{|l|}{\textbf{Total Funded Work Effort}} & \textbf{0.38}& \textbf{2.37}& \textbf{2.37}& \textbf{2.37}& \textbf{1.27} &  \textbf{8.76}\\    \hline
  ...
  \multicolumn{2}{|l|}{\textbf{Total Unfunded Work Effort}} & \textbf{0.00} & \textbf{0.00}& \textbf{0.00}& \textbf{0.00} & \textbf{0.00}& \textbf{0.00}\\\hline
  ...
  ---                     & RSE         & 0.00 & 1.00 & 1.00 & 1.00 & 0.00 & 3.00 \\  \hline
  Quansight consultant    & CEE         & 0.10 & 0.10 & 0.10 & 0.10 & 0.00 & 0.40 \\  \hline
  \multicolumn{2}{|l|}{\textbf{Grand Total of Work Efforts}} & \textbf{0.38}& \textbf{2.37}& \textbf{2.37}& \textbf{2.37}& \textbf{1.27} &  \textbf{8.76}\\    \hline
\end{tabular}
...
Salary support is requested for PI Dr.\ Thomas A.\ Caswell (0.18 FTE in year 1
and 0.16 FTE for Years 2-5).  He will participate in all aspects of the
proposed work and supervise Dr.\ Sunden.  Funds for Dr.\ Caswell will be
managed as an IAA between NASA and the DOE.

Salary support is requested for PI Dr.\ Greg Lucas (0.10 FTE in years 1-5).  He
will participate in all aspects of the proposed work, lead the Cartopy effort,
and will supervise the RSE.  All funds for Dr.\ Lucas will be managed as a
subcontract to University of Colorado.


Salary support is requested for a Dr.\ Kyle Sunden (1 FTE in years 2-5).
...
years 2-4).  The RSE will contribute to all aspects of the proposed work with a
...
Dr.\ Sunden and the RSE for the years they have salary support: one major
domestic conference and one regional domestic conference.  For the major
conference SciPy is used as a reference and for the regional conference PyData
NYC in November is used.  Travel costs are budgeted for inflation at 2.8\%.
...
Total requested for Dr.\ Sunden and the RSE: \$40,523
...
to the project for Y1-4.

Total travel requested on the grant: \$40,523
...
We request a total \$22,000 to purchase computers, monitors, and accessories
for development machines for Dr.\ Sunden and the RSE.  This will cover a
primary development machine and accessories during the Y2 (\$10,000 YR2) and to
ensure that they have access to the operating systems (Linux, Windows, MacOS)
and architectures (arm, x86\_64) required to locally reproduce and debug OS or
hardware specific issues reported (\$4,000 / yr total YR3-5).
...
\begin{itemize}
  \item Dr.\ Thomas A.\ Caswell is the PI and will oversee and contribute to
    all aspects of the proposed work and supervise finishing the work on an
    existing ROSE 2020 E.7 grant.  The time commitment is 0.18FTE .  His
    primary appointment is at Brookhaven National Laboratory which will be
    funded via an Inter Agency Agreement between NASA and DOE.
\item Dr.\ Greg Lucas is a Co-I and will oversee the Cartopy aspects of the
  proposed work.  The time commitment is 0.11FTE.  His primary appointment is at
...
\textit{Equipment}
\begin{itemize}
\item No equipment is requested.
\end{itemize}
\textit{Services}
\begin{itemize}
...
\textit{Travel}
\begin{itemize}
\item No travel support is requested.
\end{itemize}
...
\begin{itemize}
  \item Dr.\ Thomas A.\ Caswell is the PI and will oversee and contribute to
    all aspects of the proposed work.  The time commitment is 0.16FTE.  His
    primary appointment is at Brookhaven National Laboratory which will be
    funded via an Inter Agency Agreement between NASA and DOE.
  \item Dr.\ Greg Lucas is a Co-I and will oversee the Cartopy aspects of
    proposed work.  The time commitment is 0.11FTE.  His primary appointment is
    at University of Colorado Boulder which will be subcontracted for his
    effort.
\end{itemize}
\textit{Consultants}
\begin{itemize}
...
\textit{Travel}
\begin{itemize}
\item Support is requested for each Dr.\ Sunden and the RSE to attend two conferences at
...
\begin{itemize}
  \item Dr.\ Thomas A.\ Caswell is the PI and will oversee and contribute to
    ...
    funded via an Inter Agency Agreement between NASA and DOE.
\item Dr.\ Greg Lucas is a Co-I and will oversee the Cartopy aspects of
  proposed work an.  The time commitment is 0.11FTE.  His primary appointment is
  at University of Colorado Boulder which will be subcontracted for his effort.
\end{itemize}
\textit{Consultants}
\begin{itemize}
  \item Dr.\ Kyle Sunden is a Co-I and will lead the Matplotlib enhancements,
...
\textit{Equipment}
\begin{itemize}
\item \$4,000 is requested for equipment required by D.\ Sunden and the RSE.
\end{itemize}
\textit{Services}
\begin{itemize}
\item No support for services is requested.
...
\begin{itemize}
  \item Dr.\ Thomas A.\ Caswell is the PI and will oversee and contribute to
    ...
    funded via an Inter Agency Agreement between NASA and DOE.
\item Dr.\ Greg Lucas is a Co-I and will oversee the Cartopy aspects of
  proposed work.  The time commitment is 0.11FTE.  His
...
\textit{Travel}
\begin{itemize}
\item Support is requested for Dr.\ Sunden to attend two conferences at
  \$6,069.  See the budget narrative for estimated cost breakdown.
\end{itemize}
