...
We will offer dedicated time to consult with NASA funded missions on
usage of Matplotlib and Cartopy. This serves two primary purposes:
immediate assistance to NASA funded missions and highlighting areas
for improvements in documentation. This will include advice on how to use
new developments, including the data refactor from the previous ROSES award
and the new development work resulting from this award. Allocated specifically
to NASA funded missions, we propose approximately 8 FTE hours per month of
consultation. That is approximately two appointments of two hours with two
available experts per month.
